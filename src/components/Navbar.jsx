...
function ResponsiveAppBar() {
  ...
  return (
    <AppBar
      ...
      sx={{ fontFamily: ["Poppins", "sans-serif"], zIndex: 1 }}
    >
      <Container maxWidth="xl" sx={{ zIndex: 1 }}>
        <Toolbar disableGutters>
          ...
          <Link to="/">
            <Typography
              ...
              sx={{
                ...
                fontWeight: 700,
                letterSpacing: ".3rem",
                display: { xs: "none", md: "inline-block", xl: "inline-block" },
                color: "white",
                textDecoration: "none",
          ...
          <Box
            sx={{ flexGrow: 1, display: { xs: "flex", md: "none" }, zIndex: 1 }}
          >
            <IconButton
              size="large"
